function out = get_scale_sample(im, location, scaleFactors, scale_window, scale_model_sz)
...
current_target_sz = location([4,3]);
pos = location([2,1]);
for s = 1:nScales
    patch_sz = floor(current_target_sz * scaleFactors(s));
